...
namespace mini
{
    ...
    {
        public SqlConnection sqlConnection = new SqlConnection(@"Data Source=DESKTOP-CEM51B4\SQLEXPRESS;Initial Catalog=shaleen;Integrated Security=True");
        public Form1()
        {
            InitializeComponent();
        }
                ...
                else
                {
                    ...
                    else if (checkBox3.Checked)
                    {
                        for (y = x; y <= 2013; y++)
                        {
                            ...
                            sqlComman.Connection = sqlConnection;
                            sqlConnection.Open();
                            sqlComman.CommandText = "SELECT amount FROM  master  where year='" + l + "' and [Given Name] = '" + textBox3.Text + "' ";
